...
int main(int argc, char** argv)
{
    ...
    m6_opt_addii(M6_OPTION_OPTIONAL,'b',"second","This is the 2nd option", &options.opt2, -43);
    m6_opt_addbi(M6_OPTION_OPTIONAL,'c',"third","This is the 3rd option", &options.opt3, true);
    m6_opt_addsi(M6_OPTION_OPTIONAL,'d',"fourth","This is the 4th option", &options.opt4, "ha ha");
    m6_opt_addfi(M6_OPTION_OPTIONAL,'e',"fifth","This is the 5th option", &options.opt5, 43.0);
    m6_opt_addSI(M6_OPTION_OPTIONAL,'f',"sixth","This is the 6th option", &options.opt6, "error");
    ...
    for(; i < size(Vector,&options.opt6); i++){
        printf("%s ",((char**)options.opt6.mem)[i]);
    }
    printf("\n");

    printf("g= ");
    for(i=0; i < size(Vector,&options.opt7); i++){
        printf("%lf ",((double*)options.opt7.mem)[i]);
    }
    printf("\n");
