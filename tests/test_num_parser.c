...
//    "-1.1E2"                    //49
    ...
    for(; tests[i][0] != '\0'; i++ ){
        ...
        switch(i){
            case 0: num = parse_number(tests[i],0); printf("%s\n",( test_pass = (num.type == CH_UINT64 && num.val_uint == 999 && num.index == 3)    ) ? "Pass" : "Fail" ); break;
            case 1: num = parse_number(tests[i],0); printf("%s\n",( test_pass = (num.type == CH_UINT64 && num.val_uint == 100 && num.index == 4)    ) ? "Pass" : "Fail" ); break;
            case 2: num = parse_number(tests[i],0); printf("%s\n",( test_pass = (num.type == CH_INT64  && num.val_int  == -100 && num.index == 4)   ) ? "Pass" : "Fail" ); break;
            case 3: num = parse_number(tests[i],0); printf("%s\n",( test_pass = (num.type == CH_UINT64 && num.val_int  == 0 && num.index == 3)      ) ? "Pass" : "Fail" ); break;
            case 4: num = parse_number(tests[i],0); printf("%s\n",( test_pass = ( num.type == CH_UINT64 && num.val_int  == 8 && num.index == 3)     ) ? "Pass" : "Fail" ); break;
            case 5: num = parse_number(tests[i],0); printf("%s\n",( test_pass = ( num.type == CH_UINT64 && num.val_int  == 0 && num.index == 4)     ) ? "Pass" : "Fail" ); break;
            case 6: num = parse_number(tests[i],0); printf("%s\n",( test_pass = ( num.type == CH_UINT64 && num.val_int  == 0xFF && num.index == 4)  ) ? "Pass" : "Fail" ); break;
            case 7: num = parse_number(tests[i],0); printf("%s\n",( test_pass = ( num.type == CH_UINT64 && num.val_int  == 0x100 && num.index == 5) ) ? "Pass" : "Fail" ); break;
            case 8: num = parse_number(tests[i],0); printf("%s\n",( test_pass = ( num.type == CH_UINT64 && num.val_int  == 0 && num.index == 4)     ) ? "Pass" : "Fail" ); break;
            case 9: num = parse_number(tests[i],0); printf("%s\n",( test_pass = ( num.type == CH_UINT64 && num.val_int  == 1 && num.index == 4)     ) ? "Pass" : "Fail" ); break;
            case 10:num = parse_number(tests[i],0); printf("%s\n",( test_pass = ( num.type == CH_UINT64 && num.val_int  == 4 && num.index == 10)    ) ? "Pass" : "Fail" ); break;
            case 11:num = parse_number(tests[i],0); printf("%s\n",( test_pass = ( num.type == CH_DOUBLE && num.val_dble == 0.1 && num.index == 3)   ) ? "Pass" : "Fail" ); break;
            case 12:num = parse_number(tests[i],0); printf("%s\n",( test_pass = ( num.type == CH_DOUBLE && num.val_dble == 0.1 && num.index == 2)   ) ? "Pass" : "Fail" ); break;
            case 13:num = parse_number(tests[i],0); printf("%s\n",( test_pass = ( num.type == CH_DOUBLE && num.val_dble == -0.1 && num.index == 5)  ) ? "Pass" : "Fail" ); break;
            case 14:num = parse_number(tests[i],0); printf("%s\n",( test_pass = ( num.type == CH_DOUBLE && num.val_dble == -0.01 && num.index == 5) ) ? "Pass" : "Fail" ); break;
            case 15:num = parse_number(tests[i],0); printf("%s\n",( test_pass = ( num.type == CH_DOUBLE && num.val_dble == 100.0 && num.index == 6) ) ? "Pass" : "Fail" ); break;
            case 16:num = parse_number(tests[i],0); printf("%s\n",( test_pass = ( num.type == CH_DOUBLE && num.val_dble == -100.0 && num.index == 6)) ? "Pass" : "Fail" ); break;
            case 17:num = parse_number(tests[i],0); printf("%s\n",( test_pass = ( num.type == CH_UINT64 && num.val_uint == 100 && num.index == 10)  ) ? "Pass" : "Fail" ); break;
            ...
            case 28:num = parse_number(tests[i],0); printf("%s\n",( test_pass = ( num.type == CH_UINT64 && num.val_uint == 0 && num.index == 1)     ) ? "Pass" : "Fail" ); break;
            case 29:num = parse_number(tests[i],0); printf("%s\n",( test_pass = ( num.type == CH_UINT64 && num.val_uint == 1 && num.index == 1)     ) ? "Pass" : "Fail" ); break;
            case 30:num = parse_number(tests[i],0); printf("%s\n",( test_pass = ( num.type == CH_UINT64 && num.val_uint == 10 && num.index == 2)    ) ? "Pass" : "Fail" ); break;
            case 31:num = parse_number(tests[i],0); printf("%s\n",( test_pass = ( num.type == CH_UINT64 && num.val_uint == 11 && num.index == 2)    ) ? "Pass" : "Fail" ); break;
            case 32:num = parse_number(tests[i],0); printf("%s\n",( test_pass = ( num.type == CH_UINT64 && num.val_uint == 0 && num.index == 2)     ) ? "Pass" : "Fail" ); break;
            case 33:num = parse_number(tests[i],0); printf("%s\n",( test_pass = ( num.type == CH_UINT64 && num.val_uint == 0 && num.index == 3)     ) ? "Pass" : "Fail" ); break;
            case 34:num = parse_number(tests[i],0); printf("%s\n",( test_pass = ( num.type == CH_UINT64 && num.val_uint == 1000 && num.index == 2)  ) ? "Pass" : "Fail" ); break;
            case 35:num = parse_number(tests[i],0); printf("%s\n",( test_pass = ( num.type == CH_UINT64 && num.val_uint == 1024 && num.index == 3)  ) ? "Pass" : "Fail" ); break;
            case 36:num = parse_number(tests[i],0); printf("%s\n",( test_pass = ( num.type == CH_DOUBLE && num.val_dble == 1.024 * 1000 * 1000 && num.index == 6)         ) ? "Pass" : "Fail" ); break;
            ...
            case 41:num = parse_number(tests[i],0); printf("%s\n",( test_pass = ( num.type == CH_UINT64 && num.val_uint == 0 && num.index == 1)    ) ? "Pass" : "Fail" ); break;
            default: printf("Fail\n"); break;
        }
