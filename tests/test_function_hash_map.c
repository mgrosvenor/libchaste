...
//void dump_function_hash_map_i64(ch_function_hash_map* ll)
//{
//    printf("---------------------------------------------------\n");
//    printf("There are %li items in the function_hash_map\n", ll->count);
//    for(ch_function_hash_map_it i = function_hash_map_first(ll); i.value ;  function_hash_map_next(ll, &i)){
...
static ch_word test1_i64(kv* test_data)
{
    ...
    ch_function_hash_map* hm1 = ch_function_hash_map_new(10,sizeof(void*),cmp_i64);
