...
\
    ch_llist_##NAME##_it (*push_front)(ch_llist_##NAME##_t* this, u64 value); /* Put an element at the front of the llist list values,*/\
    ch_llist_##NAME##_it (*pop_front)(ch_llist_##NAME##_t* this);/* Push an element off the front of the llist list values,*/\
    ch_llist_##NAME##_it (*push_back)(ch_llist_##NAME##_t* this, u64 value); /* Put an element at the back of the llist values*/\
    ch_llist_##NAME##_it (*pop_back)(ch_llist_##NAME##_t* this); /* Push an element at the back of the llist values*/\
\
    ch_llist_##NAME##_it* (*insert_after)(ch_llist_##NAME##_t* this, ch_llist_##NAME##_it* itr, u64 value); /* Insert an element after the element given by ptr*/\
    ch_llist_##NAME##_it* (*insert_before)(ch_llist_##NAME##_t* this, ch_llist_##NAME##_it* it, u64 value); /* Insert an element before the element giver by ptr*/\
...
\
    ch_llist_##NAME##_it (*push_back_carray)(ch_llist_##NAME##_t* this, const u64* carray, ch_word count); /*Push back count elements the C llist to the back llist-list*/\
\
    ch_word (*eq)(ch_llist_##NAME##_t* this, ch_llist_##NAME##_t* that); /*Check for equality*/\
    ch_llist_##NAME##_it (*find)(ch_llist_##NAME##_t* this, ch_llist_##NAME##_it* begin, ch_llist_##NAME##_it* end, u64 value); /*find the given value using the comparator function*/\
