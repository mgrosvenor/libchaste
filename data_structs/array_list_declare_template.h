...
\
struct ch_array_##TYPE{\
    ch_word size;  /*Return the max number number of elements in the array*/\
...
\
    TYPE*(*push_front)(ch_array_##TYPE##_t* this, TYPE value); /* Put an element at the front of the array values, [WARN: In general this is very expensive for an array] */\
    TYPE*(*push_back)(ch_array_##TYPE##_t* this, TYPE value); /* Put an elemenet at the back of the arary values*/\
    TYPE*(*insert_after)(ch_array_##TYPE##_t* this, TYPE* ptr, TYPE value); /* Insert an element after the element given by ptr*/\
    TYPE*(*insert_before)(ch_array_##TYPE##_t* this, TYPE* ptr, TYPE value); /* Insert an element before the element giver by ptr [WARN: In general this is very expensive for an array] */\
...
\
\
     /* Members prefixed with "_" are nominally "private" Don't touch!*/\
