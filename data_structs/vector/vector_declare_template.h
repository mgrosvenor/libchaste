...
struct ch_vector_##TYPE{\
    ...
    void (*resize)(ch_vector_##TYPE##_t* this, ch_word new_size); /*Resize the array*/\
...
\
    TYPE* (*find)(ch_vector_##TYPE##_t* this, TYPE* begin, TYPE* end, TYPE value); /*find the given value using the comparitor function*/\
    void (*sort)(ch_vector_##TYPE##_t* this); /*sort into order given the comparitor function*/\
    void (*sort_reverse)(ch_vector_##TYPE##_t* this); /*sort into reverse order given the comparitor function*/\
\
    TYPE* (*push_front)(ch_vector_##TYPE##_t* this, TYPE value); /* Put an element at the front of the array list values, [WARN: In general this is very expensive for an array] */\
    TYPE* (*push_back)(ch_vector_##TYPE##_t* this, TYPE value); /* Put an elemenet at the back of the arary values*/\
    TYPE* (*insert_after)(ch_vector_##TYPE##_t* this, TYPE* ptr, TYPE value); /* Insert an element after the element given by ptr*/\
    TYPE* (*insert_before)(ch_vector_##TYPE##_t* this, TYPE* ptr, TYPE value); /* Insert an element before the element giver by ptr [WARN: In general this is very expensive for an array] */\
    TYPE* (*remove)(ch_vector_##TYPE##_t* this, TYPE* ptr); /*Remove the given ptr [WARN: In general this is very expensive] */\
\
    void (*delete)(ch_vector_##TYPE##_t* this); /*Free the resources associated with this array, assumes that individual items have been freed*/ \
\
    TYPE* (*push_back_carray)(ch_vector_##TYPE##_t* this, TYPE* carray, ch_word count); /*Push back count elements the C array to the back array-list*/\
\
