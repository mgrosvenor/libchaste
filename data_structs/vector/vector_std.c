...
define_ch_vector_cmpp(u8p,  u8*)
define_ch_vector_cmpp(u16p, u16*)
define_ch_vector_cmpp(u32p, u32*)
define_ch_vector_cmpp(u64p, u64*)
...
define_ch_vector_cmpp(i8p,  i8*)
define_ch_vector_cmpp(i16p, i16*)
define_ch_vector_cmpp(i32p, i32*)
define_ch_vector_cmpp(i64p, i64*)
...
ch_word ch_vector_string(ch_str* lhs, ch_str* rhs)\
{
    return strcmp(lhs->cstr, rhs->cstr);
}

ch_word ch_vector_cstr(ch_cstr* lhs, ch_cstr* rhs)\
{
    return strcmp( (*lhs), (*rhs) ) ;
}


define_ch_vector_cmpp(machinep, ch_machine*)
define_ch_vector_cmpp(wordp, ch_word*)
define_ch_vector_cmpp(charp, ch_char*)
define_ch_vector_cmpp(boolp, ch_bool*)
define_ch_vector_cmpp(floatp, ch_float*)
define_ch_vector_cmpp(stringp, ch_str*)
